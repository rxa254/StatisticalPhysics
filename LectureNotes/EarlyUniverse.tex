...
\end{align}
So in this early, radiation dominated era, $\tau \propto 1/\sqrt{t}$. In SI units, we can write this (after plugging in numbers):
\begin{equation}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.75\columnwidth]{Figures/cobe53ghz.png}
